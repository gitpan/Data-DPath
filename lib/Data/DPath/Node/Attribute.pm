package Data::DPath::Node::Attribute;
...
package Data::DPath::Node::AttributeImpl;

use vars qw/@ISA/;
@ISA = ('Data::DPath::NodeImpl', 'Data::DPath::Node::Attribute');
...
# 	}
	$string .= join('',
					$self->[node_key],
					'="',
					Data::DPath::Node::XMLescape($self->[node_value], '"&><'),
					'"');
	return $string;
}
