...
sub evaluate {
    ...
    #warn "Eval Literal: ", $self -> as_string, "\n";
	$self;
}

sub to_boolean {
	my $self = shift;
	return (length($$self) > 0) ? Data::DPath::Boolean->True : Data::DPath::Boolean->False;
}

sub to_number { return Data::DPath::Number->new($_[0]->value); }
...
Data::DPath::Literal - Simple string values.

=head1 DESCRIPTION

In DPath terms a Literal is what we know as a string.
