...
sub evaluate {
    my $self = shift;
        #warn "Eval Number: ", $self -> as_string, "\n";
    $self;
}

sub to_boolean {
    my $self = shift;
    return $$self ? Data::DPath::Boolean->True : Data::DPath::Boolean->False;
}

sub to_literal { Data::DPath::Literal->new($_[0]->as_string); }
sub to_number { $_[0]; }
...
Data::DPath::Number - Simple numeric values.
...
Creates a new Data::DPath::Number object, with the value in $num. Does some
