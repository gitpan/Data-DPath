package Data::DPath::Variable;
use strict;

# This class does NOT contain 1 instance of a variable
# see the Data::DPath::Parser class for the instances
...
sub evaluate {
    ...
    #warn "Eval Variable: ", $self -> as_string, "\n";
    #warn "Evaluate Variable returning: ", Data::Dumper -> Dump([$val]);
    return $val;
}
